...
public class TC_04_UpdateProfileWebSite extends CBase {
	public WebDriver driver;

	@Given("^update the profile url$")
	public void update_the_profile_url() throws Throwable {
		...
		updateurl.click();
		updateurl.clear();
		updateurl.sendKeys("https://www.twitter.com");
